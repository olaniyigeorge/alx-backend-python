...
@parameterized_class([
    {
        "org_payload": fixtures.TEST_PAYLOAD["org_payload"],
        "repos_payload": fixtures.TEST_PAYLOAD["repos_payload"],
        "expected_repos": fixtures.TEST_PAYLOAD["expected_repos"],
        "apache2_repos": fixtures.TEST_PAYLOAD["expected_repos"]
    }
])
